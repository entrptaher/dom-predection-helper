...
var _diff_match_patch = __webpack_require__(1);
...
window.diff_match_patch = _diff_match_patch.diff_match_patch;

window.DomPredictionHelper = _dom2.default;
...
var DomPredictionHelper = function () {
	function DomPredictionHelper() {
		_classCallCheck(this, DomPredictionHelper);
	}

	_createClass(DomPredictionHelper, [{
		key: "recursiveNodes",
		value: function recursiveNodes(e) {
			var n = void 0;
		...
		key: "escapeCssNames",
		value: function escapeCssNames(name) {
			if (name) {
				try {
		...
		key: "childElemNumber",
		value: function childElemNumber(elem) {
			var count = void 0;
			count = 0;
		...
		key: "siblingsWithoutTextNodes",
		value: function siblingsWithoutTextNodes(e) {
			var filtered_nodes = void 0,
			    node = void 0,
			    nodes = void 0,
			    _i = void 0,
			    _len = void 0;
		...
		key: "cssDescriptor",
		value: function cssDescriptor(node) {
			var cssName = void 0,
			    escaped = void 0,
			    path = void 0,
			    _i = void 0,
		...
		key: "cssDiff",
		value: function cssDiff(array) {
			var collective_common = void 0,
			    cssElem = void 0,
			    diff = void 0,
			    dmp = void 0,
			    encoded_css_array = void 0,
			    existing_tokens = void 0,
			    part = void 0,
			    _i = void 0,
			    _j = void 0,
			    _len = void 0,
		...
		key: "tokenizeCss",
		value: function tokenizeCss(css_string) {
			var char = void 0,
			    skip = void 0,
			    tokens = void 0,
			    word = void 0,
		...
		key: "tokenizeCssForDiff",
		value: function tokenizeCssForDiff(css_string) {
			var block = void 0,
			    combined_tokens = void 0,
			    token = void 0,
			    _i = void 0,
			    _len = void 0,
			    _ref = void 0;
		...
		key: "decodeCss",
		value: function decodeCss(string, existing_tokens) {
		...
		key: "encodeCssForDiff",
		value: function encodeCssForDiff(strings, existing_tokens) {
		...
		key: "tokenPriorities",
		value: function tokenPriorities(tokens) {
			var epsilon = void 0,
			    first = void 0,
			    i = void 0,
			    priorities = void 0,
		...
		key: "orderFromPriorities",
		value: function orderFromPriorities(priorities) {
			var i = void 0,
			    ordering = void 0,
			    tmp = void 0,
			    _i = void 0,
		...
		key: "simplifyCss",
		value: function simplifyCss(css, selected, rejected) {
			var best_so_far = void 0;
			var first = void 0;
			var got_shorter = void 0;
			var i = void 0;
			var look_back_index = void 0;
			var ordering = void 0;
			var part = void 0;
			var parts = void 0;
		...
		key: "_removeElements",
		value: function _removeElements(part, parts, firstChar, callback) {
			var j = void 0,
			    look_back_index = void 0,
			    selector = void 0,
			    tmp = void 0,
			    _i = void 0,
			    _j = void 0;
		...
		key: "positionOfSpaceBeforeIndexOrLineStart",
		value: function positionOfSpaceBeforeIndexOrLineStart(part, parts) {
			var i = void 0;
			i = part;
			while (i >= 0 && parts[i] !== " ") {
				i--;
		...
		key: "wouldLeaveFreeFloatingNthChild",
		value: function wouldLeaveFreeFloatingNthChild(parts, part) {
			var i = void 0,
			    nth_child_is_on_right = void 0,
			    space_is_on_left = void 0;
		...
		key: "cleanCss",
		value: function cleanCss(css) {
			var cleaned_css = void 0,
			    last_cleaned_css = void 0;
			cleaned_css = css;
		...
		key: "getPathsFor",
		value: function getPathsFor(nodeset) {
			var node = void 0,
			    out = void 0,
			    _i = void 0,
			    _len = void 0;
		...
		key: "predictCss",
		value: function predictCss(s, r) {
			var css = void 0,
			    selected = void 0,
			    selected_paths = void 0,
			    simplest = void 0,
			    union = void 0,
			    _i = void 0,
			    _len = void 0;
		...
		key: "selectorGets",
		value: function selectorGets(type, list, the_selector) {
		...
		key: "cssToXPath",
		value: function cssToXPath(css_string) {
			var css_block = void 0,
			    out = void 0,
			    token = void 0,
			    tokens = void 0,
			    _i = void 0,
		...
		key: "cssToXPathBlockHelper",
		value: function cssToXPathBlockHelper(css_block) {
			var current = void 0,
			    expressions = void 0,
			    first = void 0,
			    i = void 0,
...
exports.default = DomPredictionHelper;
